"use client";
import { AtEmailIcon, LockIcon, ProfileIcon, WarningIcon } from "../Icons";
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <ProfileIcon className="h-5 w-5 text-gray-500 dark:text-gray-400 group-focus-within:text-blue-500 transition-colors"/>
